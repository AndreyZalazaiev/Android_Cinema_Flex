...
public class buyed_tickets extends AppCompatActivity {
    ...
    public void setupContent(LinearLayout content, final Tickets tk)
    {
        ...
        tv.setTextColor(Color.BLACK);
        tv.setText(Html.fromHtml("Cinema: "+tk.getCinemaname()+"<br/>"
                +"Adress: "+ tk.getCinemaadress()+"<br/>"
                +"Hall name: <b>"+tk.getHallname()+"</b><br/>"
                +"Hall type:<b>"+tk.getHalltype()+"</b><br/>"
                +"Price: <u>"+tk.getPrice()+"</u><br/>"
                +"Row: <u>"+tk.getRow()+"</u> Place: <u>"+tk.getPlace()+"</u><br/><b>"
                +tk.getStart().toString().substring(tk.getStart().toString().length()-4,tk.getStart().toString().length())+" "+tk.getStart().toString().substring(0,11)+"<br/>"
